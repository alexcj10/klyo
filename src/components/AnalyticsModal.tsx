      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            {/* Content */}
            <div className={hasData ? "overflow-y-auto max-h-[calc(95vh-120px)] sm:max-h-[calc(90vh-100px)] scrollbar-hide pt-4 sm:pt-6" : "flex-1 flex items-center justify-center px-4 sm:px-6"}>
