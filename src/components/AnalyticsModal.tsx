      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className={`w-[94%] sm:w-full ${hasData ? 'max-w-[340px] sm:max-w-[95%] md:max-w-[85%] lg:max-w-[80%] xl:max-w-5xl' : 'max-w-[340px] sm:max-w-lg'} max-h-[70vh] sm:max-h-[90vh] md:max-h-[75vh] lg:max-h-[75vh] xl:max-h-[85vh] bg-gray-50 rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden`}
          ...
          >
            ...
            {/* Content */}
            <div className={hasData ? "overflow-y-auto max-h-[calc(70vh-100px)] sm:max-h-[calc(90vh-100px)] md:max-h-[calc(75vh-100px)] lg:max-h-[calc(75vh-100px)] xl:max-h-[calc(85vh-100px)] scrollbar-hide" : "flex-1 flex items-center justify-center px-4 sm:px-6"}>
