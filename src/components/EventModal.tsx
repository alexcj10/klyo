    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white rounded-2xl shadow-2xl w-[94%] sm:w-full max-w-[340px] sm:max-w-lg md:max-w-xl lg:max-w-xl max-h-[70vh] sm:max-h-[75vh] lg:max-h-[85vh] overflow-hidden border border-gray-200"
