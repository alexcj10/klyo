              ...
              <div className="space-y-6">
                <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100">
                  ...
                  <div className="space-y-4">
                    ...
                    {/* Labels Placeholder (Visual) */}
                    <div className="flex flex-col gap-2">
                      <span className="text-[10px] font-bold text-slate-500">Labels</span>
                      <div className="flex flex-wrap gap-1.5">
                        {labels.map(l => (
                          <span key={l} className="text-[10px] font-black bg-white border border-slate-100 shadow-sm px-2 py-1 rounded-md text-slate-600">
                            {l}
                          </span>
                        ))}
                        <button className="p-1 rounded-md border border-dashed border-slate-300 text-slate-300 hover:text-blue-400 hover:border-blue-400 transition-all">
